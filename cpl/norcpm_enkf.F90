...
contains
    ...
    subroutine write_analysisfields_file(ofn)
        ...
        write(fid,'(a)')'ub        1 1'
        write(fid,'(a)')'vb        1 1'
        !!no this variable!! write(fid,'(a)')'ubflx     1 1'
        !!no this variable!! write(fid,'(a)')'vbflx     1 1'
        ...
        !!no this variable!! write(fid,'(a)')'ustar     0 0'
        !!no this variable!! write(fid,'(a)')'buoyfl    0 0 '
        close(fid)
