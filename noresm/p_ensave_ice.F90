...
subroutine ensave_ice(cbasis,nmem)
use netcdf
use nfw_mod
   implicit none
   ...
   !!not use here!!else
   !!not use here!!   print *,'"ensave_ice" -- A light and smart ensave for ice'
   !!not use here!!   print *
   !!not use here!!   print *,'usage: '
   !!not use here!!   print *,'   ensave_ice cbasis ensemble_size'
  ...
  ! print *, 'The model dimension is :',idm,jdm,kdm
   ...
   call nfw_close(trim(oldfile), ncid)
end subroutine ensave_ice

end module m_ensave_ice
