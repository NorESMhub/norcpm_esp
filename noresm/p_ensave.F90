...
contains
subroutine p_ensave(cbasis,nmem)
  ...
  character(len=80):: oldfile, ctmp
  character(len=*) :: cbasis
  logical          :: ex
  ...
  !not use here!!if (iargc()==2 ) then
  !not use here!!   call getarg(1,cbasis)
  !not use here!!   call getarg(2,ctmp)
  !not use here!!   read(ctmp,*) nmem
  !not use here!!else
  !not use here!!   print *,'"ensave" -- A light and smart ensave'
  !not use here!!   print *
  !not use here!!   print *,'usage: '
  !not use here!!   print *,'   ensave cbasis ensemble_size'
  !not use here!!   print *,'ex:   ./ensave analysis 30'
  !not use here!!   print *,'ex:   mpirun -n 30 ./ensave analysis 30'
